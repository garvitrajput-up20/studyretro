    ...
    <footer className="bg-gray-900 text-white py-8">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-5">
        <div className="flex flex-col md:flex-row items-center">
          ...
          />
          <p className="ml-2 md:ml-0 text-center md:text-left text-sm">© 2024 StudyRetro. All rights reserved.</p>
        </div>
        <nav className="mt-4 md:mt-0">
          <ul className="flex flex-col md:flex-row list-none items-center">
